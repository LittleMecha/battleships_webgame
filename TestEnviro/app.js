...
randomButton.addEventListener('click', startSinglePlayer)
function startSinglePlayer() {
	userSquares.forEach(userSquares => userSquares.setAttribute("class", ""))
...
function createBoard(grid, squares) {
  ...
  createBoard(opponentGrid, opponentGridSquares)
